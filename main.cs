...
class Program
{
    ...
    public static void PerformActivity(int choice2)
    {
        ...
        {
            case 1:
                Console.WriteLine(moneyface());
                break;
            case 2:
                Console.WriteLine(foobar());
                break;
            case 3:
                Console.WriteLine(joinword());
                break;
            case 4:
                Console.WriteLine(pyramid());
                break;
            case 5:
                Console.WriteLine(sumappend());
                break;
            default:
                Console.WriteLine("Activity does not exist. Choose activity from 1 - 5");
                break;
        }
    }

    public static string moneyface()
    {
        double value2;
        string exit = "exit";
    ...
    public static string sumappend()
    {
        int num1 = 0;
        string message = "";
